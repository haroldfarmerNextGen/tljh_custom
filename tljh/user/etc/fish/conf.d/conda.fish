set -gx CONDA_EXE "/opt/tljh/user/bin/conda"
set _CONDA_ROOT "/opt/tljh/user"
set _CONDA_EXE "/opt/tljh/user/bin/conda"
set -gx CONDA_PYTHON_EXE "/opt/tljh/user/bin/python"
